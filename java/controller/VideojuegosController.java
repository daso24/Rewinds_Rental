	...
	public class VideojuegosController {
	    ...
	    private class InfoJuegoInternalController { 
	        ...
	        private void initEventsInfo() {
	            ...
	            vistaInfo.lblInicio.addMouseListener(new MouseAdapter() {
	                @Override
	                public void mouseClicked(MouseEvent e) {
	                    vistaInfo.dispose();// cerrar la vista actual
	            ...
	            vistaInfo.lblVideojuegos.addMouseListener(new MouseAdapter() {
	                @Override
	                public void mouseClicked(MouseEvent e) {
	                    vistaInfo.dispose();
