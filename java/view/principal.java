...
public class principal extends JFrame {
    ...
    public principal() {
        ...
        JLabel logoLabel = new JLabel(new ImageIcon(new ImageIcon(principal.class.getResource("/img/logo0.png")).getImage().getScaledInstance(80, 80, Image.SCALE_SMOOTH)));
        ...
        // BOTÓN SALIR IMAGEN
        ImageIcon exitIcon = new ImageIcon(new ImageIcon(getClass().getResource("/img/material-symbols_logout-sharp.png")).getImage().getScaledInstance(40, 40, Image.SCALE_SMOOTH));
        JLabel logoutBtn = new JLabel(exitIcon);
        logoutBtn.setBounds(720, 30, 40, 40);
        logoutBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));
        logoutBtn.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) { mostrarConfirmacionSalir(); }
        });
    ...
    public void Menu(JPanel panel, String texto, int y, Icon icono) {
        JLabel iconLabel = new JLabel(icono); iconLabel.setBounds(15, y, 25, 30);
        ...
        label.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                if (ventana != null) { dispose(); ventana.setVisible(true); }
            }
        });
    ...
    private JPanel Card(String titulo, String numero) {
        ...
        btn.addActionListener(e -> {
            ...
            if (titulo.equals("Clientes")) new clientes().setVisible(true);
            else if (titulo.equals("Rentas y Ventas")) new operaciones().setVisible(true);
        });
    ...
    private JPanel crearCardDoble(String titulo) {
        ...
        java.awt.event.ActionListener accion = e -> {
            dispose(); // CIERRA VENTANA ACTUAL
            if (titulo.equals("Videojuegos")) new juegomas_rentado().setVisible(true);
            else if (titulo.equals("Peliculas")) new peliculamas_rentada().setVisible(true);
        };
        b1.addActionListener(accion); b2.addActionListener(accion);

        panel.add(t); panel.add(m1); panel.add(m2); panel.add(b1); panel.add(b2);
        return panel;
    }

    public static void main(String[] args) { SwingUtilities.invokeLater(() -> new principal()); }
}