...
public class peliculas extends JFrame {
    ...
    public peliculas() {
        ...
        JPanel atrasContenedor = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0));
        atrasContenedor.setOpaque(false);
        atrasContenedor.setPreferredSize(new Dimension(220, 40));
        ...
        headerPanel.add(atrasContenedor, BorderLayout.WEST);
        ...
        Icon iconoPeliGrande = getImg("/img/fluent_movies-and-tv-16-filled.png", 40, 40);
        Icon iconoVector = getImg("/img/Vector.png", 20, 20);

        Object[][] datos = {
            {false, getImg("/img/811xdZfsUqL.jpg", 50, 60), "Avengers Infinity War", "PEL-00017", new Object[]{iconoPeliGrande, "Película"}, "Blu-Ray", new Object[]{iconoVector, "Ver info"}},
            {false, getImg("/img/71w58zkWnfL.jpg", 50, 60), "Chainsaw Man - Reze", "PEL-10024", new Object[]{iconoPeliGrande, "Película"}, "Blu-Ray", new Object[]{iconoVector, "Ver info"}},
            {false, getImg("/img/61MZdcVwQFL.jpg", 50, 60), "Rocky", "PEL-03085", new Object[]{iconoPeliGrande, "Película"}, "DVD", new Object[]{iconoVector, "Ver info"}},
            {false, getImg("/img/20504502.jpg", 50, 60), "Shrek 2", "PEL-00547", new Object[]{iconoPeliGrande, "Película"}, "DVD", new Object[]{iconoVector, "Ver info"}},
            {false, getImg("/img/71MZBMmOXtL._AC_UF894,1000_QL80_.jpg", 50, 60), "DB Super Broly", "PEL-00723", new Object[]{iconoPeliGrande, "Película"}, "Blu-Ray", new Object[]{iconoVector, "Ver info"}}
        };
