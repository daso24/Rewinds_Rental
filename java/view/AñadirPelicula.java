...
public class AñadirPelicula extends JFrame {
    ...
    public AñadirPelicula() {
        ...
        cbStockVenta = crearCombo(mainPanel, new String[]{"Disponibles para Venta", "1", "5", "10", "20"}, 30, 545, 180);
        cbStockRenta = crearCombo(mainPanel, new String[]{"Disponibles para Renta", "1", "5", "10", "20"}, 250, 545, 180);

        crearLabel(mainPanel, "Clasificación:", 450, 430);
        cbClasif = crearCombo(mainPanel, new String[]{"C", "E", "E+10", "T", "M"}, 450, 455, 160);
    ...
    public void mostrarError(String mensaje) {
        mostrarPopUpBase(mensaje, new Color(220, 50, 50), "/img/mingcute_warning-fill.png");
    }

    public void mostrarExito(String mensaje) {
        mostrarPopUpBase(mensaje, new Color(50, 180, 50), "/img/ic_baseline-plus.png");
    }

    private void mostrarPopUpBase(String mensaje, Color colorBoton, String rutaIcono) {
