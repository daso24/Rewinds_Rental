...
public class juegomas_rentado extends JFrame {
    ...
    public juegomas_rentado() {
        ...
        nombreTxt = crearCampo(panel, "Nombre del videojuego:", 50, 80, 250, "Resident evil requiem");
        idTxt = crearCampo(panel, "ID del producto:", 50, 155, 250, "VID-00892");
        tipoTxt = crearCampo(panel, "Tipo de producto:", 50, 230, 250, "Videojuego");
        plataformaTxt = crearCampo(panel, "Plataforma:", 50, 305, 250, "PlayStation 4 / 5");
        ventaTxt = crearCampo(panel, "Precio Venta:", 50, 385, 110, "$ 1,100.00");
        rentaTxt = crearCampo(panel, "Precio Renta:", 190, 385, 110, "$ 150.00");
        ...
        ventaStock = new JTextField("V: 5");
        ventaStock.setBounds(340, 410, 80, 30);
        ventaStock.setEditable(false);
        panel.add(ventaStock);

        rentaStock = new JTextField("R: 3");
        rentaStock.setBounds(430, 410, 80, 30);
        rentaStock.setEditable(false);
        panel.add(rentaStock);

        clasificacionTxt = crearCampoCentro(panel, "Clasificación:", 350, 80, 130, "M (Mature)");
        añoTxt = crearCampoCentro(panel, "Lanzamiento:", 350, 155, 130, "2020");
        generoTxt = crearCampoCentro(panel, "Género:", 350, 230, 130, "Aventura / Acción");
