...
public class videojuegos extends JFrame
{
    ...
    public videojuegos()
    {
        ...
        lblBuscar.setFont(INTER_BOLD_13);
        ...
        tabla.getColumnModel().getColumn(7).setCellRenderer(new InfoButtonRenderer());
    ...
    public void cargarDatosTabla(java.util.List<Object[]> listaJuegos)
    {
        modelo.setRowCount(0);
        Icon iconoConsola = getImg("/img/carbon_game-console.png", 40, 40);
        Icon iconoVector = getImg("/img/Vector.png", 20, 20);

        for (Object[] juego : listaJuegos)
        {
            int id = (int) juego[0];
            String titulo = (String) juego[1];
            String plataforma = (String) juego[2];
            String precioRenta = (String) juego[3];
            String rutaFoto = (String) juego[4];

            Icon foto = null;
            if (rutaFoto != null && !rutaFoto.isEmpty())
            {
                foto = getImg(rutaFoto, 50, 60);
            }
            ...
            modelo.addRow(new Object[]{
                ...
                titulo, 
                id, 
                new Object[]{iconoConsola, "Videojuego"}, 
                plataforma, 
                precioRenta, 
                new Object[]{iconoVector, "Ver info"}
            });
        }
    }
