...
public class ClienteController
{
            ...
            this.vistaTabla.btnBuscar.addActionListener(e ->
            {
                ...
                else
                {
                    ...
                    if (!clientesEncontrados.isEmpty())
                    {
                        ...
                        try
                        {
                            infoIcon = new ImageIcon(new ImageIcon(getClass().getResource("/img/Vector.png")).getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH));
                        }
                        catch (Exception ex)
                        {
                        }
                        ...
                        for (Object[] clienteEncontrado : clientesEncontrados)
                        {
                            ...
                            {
                                ImageIcon icon;
                                if (rutaDB != null && rutaDB.startsWith("/"))
                                {
                                    icon = new ImageIcon(getClass().getResource(rutaDB));
                                }
                                else
                                {
                                    icon = new ImageIcon(rutaDB != null ? rutaDB : "/img/placeholder_usuario.png");
                                }
                            ...
                            catch (Exception ex)
                            {
                                try
                                {
                                    userIcon = new ImageIcon(new ImageIcon(getClass().getResource("/img/placeholder_usuario.png")).getImage().getScaledInstance(35, 35, Image.SCALE_SMOOTH));
                                }
    ...
    private void initEventsAdd()
    {
        ...
        if (vistaAgregar.btnAgregarCliente != null)
        {
            vistaAgregar.btnAgregarCliente.addActionListener(e ->
            {
                ...
                if (ruta == null || ruta.isEmpty() || ruta.contains("agregar-contacto"))
                {
                    ruta = "/img/placeholder_usuario.png";
                }
    ...
    private void configurarMenuLateral(JComponent inicio, JComponent operacion, JComponent clientesBtn, JComponent videojuegosLbl, JComponent peliculasLbl, JFrame ventanaActual)
    {
        ...
        if (clientesBtn != null)
        {
            clientesBtn.addMouseListener(new MouseAdapter()
            {
                @Override
                public void mouseClicked(MouseEvent e)
                {
